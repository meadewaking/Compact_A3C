...
class AC(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(2304, 340)
        self.fc_pi = nn.Linear(340, 6)
...
def train(global_model, global_r_lst):
    ...
    scheduler = torch.optim.lr_scheduler.StepLR(optimizer, 4000, gamma=0.8)
    alpha = 0.5
    ...
    for n_epi in range(max_train_ep):
        ...
        if n_epi % 100 == 0:
            torch.save(local_model, 'model/student20.pth')
    env.close()
